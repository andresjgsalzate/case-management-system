...
router.put("/:teamId/members/:userId", (0, TeamAuthorizationMiddleware_1.requireAnyPermission)(["teams.manage.members"]), teamController.updateTeamMember);
router.patch("/:teamId/members/:userId/role", (0, TeamAuthorizationMiddleware_1.requireAnyPermission)(["teams.manage.members"]), teamController.updateMemberRole);
router.delete("/:teamId/members/:userId", (0, TeamAuthorizationMiddleware_1.requireAnyPermission)(["teams.manage.members"]), teamController.removeTeamMember);
