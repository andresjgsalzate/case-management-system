...
export default function DocumentTypeEditModal({
  ...
  const [formData, setFormData] = useState<UpdateDocumentTypeDto>({
    code: "",
    name: "",
    description: "",
    icon: "",
  ...
  // Cargar datos del tipo de documento cuando el modal se abre
  useEffect(() => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setIsLoading(true);
    try {
      await DocumentTypeService.update(documentType.id, {
        ...formData,
      ...
      showError(error.message || "Error al actualizar el tipo de documento");
    } finally {
      setIsLoading(false);
    }
  };
  ...
  const handleInputChange = (
    field: keyof UpdateDocumentTypeDto,
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div>
          ...
          <p className="mt-1 text-xs text-gray-500 dark:text-gray-400">
            {(formData.code || "").length}/50 caracteres. Solo letras, números,
        ...
        <div>
          ...
          <p className="mt-1 text-xs text-gray-500 dark:text-gray-400">
            Los tipos de documento inactivos no aparecerán como opciones en los
            formularios
          </p>
        </div>
          ...
          <div className="text-sm text-blue-800 dark:text-blue-200">
            ...
            <ul className="space-y-1">
              ...
              <li>
                ...
                {new Date(documentType.updatedAt).toLocaleDateString()}
              </li>
              <li>• ID: {documentType.id}</li>
            </ul>
          </div>
        </div>
