...
export const PermissionEditModal: React.FC<PermissionEditModalProps> = ({
  permission,
  onClose,
  onSuccess,
  modules,
  ...
  const handleInputChange = (
    field: keyof UpdatePermissionRequest,
    value: any
  ) => {
  ...
  return (
    <Modal isOpen onClose={onClose} title="Editar Permiso">
